...
var ReactDataList = (function (_React$Component) {
    ...
    function ReactDataList(props) {
        ...
        this.state = {
            ...
            menuFilter: props.initialMenuFilter || props.defaultValue || '',
            hide: true,
            selected: false,
            menuSelected:false,
    ...
    _createClass(ReactDataList, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(_componentsDataList2['default'], { ref: 'theDatalist',
                    ...
                    selectMenu: this.selectFilteredMenu.bind(this),
                    options: options,
                    optionsMenu: this.props.optionsMenu || "",
                    menuTitle: this.props.menuTitle || "",
                    selected: this.state.filter,
                    menuSelected: this.state.menuFilter,
        ...
        value: function handleInputBlur(event) {
            var isInInput = document.querySelector(`input#${this.props.list}`).contains(event.target);
            var isInMenu = document.querySelector(`#${this.props.list}-menu`) ? document.querySelector(`#${this.props.list}-menu`).contains(event.target) : false;
            if (this.props.hideOptionsOnBlur && !isInInput && !isInMenu) {
                setTimeout((function () {
        ...
        value: function handleInputKeyDown(event) {
            switch (event.which) {
                ...
                case 38:
                    // UP arrow
                    newSelectedIndex = this.state.selected > 0 ? this.state.selected - 1 : 0;
        ...
        key: 'selectFilteredMenu',
        value: function selectFilteredMenu(index) {
            this.selectOptionMenu(this.filterOptions(this.props.optionsMenu, '', this.useNative())[index]);
        }
    }, {
        key: 'selectOption',
        value: function selectOption(value) {
            ...
            this.props.options.forEach(function (option, index) {
                ...
                if (option.toLowerCase() === value.toLowerCase()) {
                    selected_option = option; selected_index = index;
                }
                }
            });
            ...
            this.props.getSelectedOption(selected_option);
        }
    }, {
        key: 'selectOptionMenu',
        value: function selectOptionMenu(value) {
            var selected_option;
            var selected_index;
            this.props.optionsMenu.forEach(function (option, index) {
                if(option) {
                if (option.toLowerCase() === value.toLowerCase()) {
                    selected_option = option; selected_index = index;
                }
            ...
            if (typeof selected_option === 'undefined') return;
            if (typeof this.props.onOptionMenuSelected === 'function') this.props.onOptionMenuSelected(selected_option);
            this.setState({
                menuFilter: selected_option,
                menuSelected: selected_index,
                hide: false
            });
            this.props.getSelectedMenu(selected_option);
        }
    }, {
        key: 'useNative',
            ...
            if (typeof this.props.getController === 'function') {
                this.props.getController({
                    ...
                    toggleOptions: (function (callback) {
                        ...
                        this.setState({ filter: '', hide: hide }, function () {
                    ...
                    getState: (function () {
                        return {
                            ...
                            optionsMenu : this.filterOptions(this.props.optionsMenu, '', this.useNative()),
        ...
        value: function componentDidMount() {
            ...
            document.addEventListener('click', this.handleInputBlur.bind(this))
            document.removeEventListener('click', this.handleInputBlur.bind(this))
        }
    }, {
        key: 'findPos',
